...
const instance = (input, value, min = 100, max) => ({
...
rangeSlider.create(scootersNumberInput, instance(scootersNumberInput, 300))

const revenuePerScooterInput = document.querySelector('#revenuePerScooter')
rangeSlider.create(revenuePerScooterInput, instance(revenuePerScooterInput, 575, 150, 1000))
